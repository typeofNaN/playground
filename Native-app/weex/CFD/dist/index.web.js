...
/* WEBPACK VAR INJECTION */(function(global) {console.log('START WEEX VUE RENDER: 0.12.32, Build 2018-10-18 11:48.');
'use strict';
...
if (!Object.setPrototypeOf) {
  Object.setPrototypeOf = function (Object, magic) {
    ...
    try {
      ...
      if ( // IE < 11 cannot be shimmed
      Object.prototype !== {}[magic] || // neither can any browser that actually
      // implemented __proto__ correctly
      // (all but old V8 will return here)
      {
        __proto__: null
      }.__proto__ === void 0 // this case means null objects cannot be passed
...
var defined$2 = _defined; // true  -> String#at
...
var toIObject$2 = _toIobject; // 22.1.3.4 Array.prototype.entries()
...
var _iterCall = function (iterator, fn, value, entries) {
  try {
    return entries ? fn(anObject$3(value)[0], value[1]) : fn(value); // 7.4.6 IteratorClose(iterator, completion)
  } catch (e) {
...
function isElementVisible(el, container, dir, offset) {
  ...
  var ctRect = container === window || container === document.body ? bodyRect : container ? container.getBoundingClientRect() : bodyRect; // if container is not visible, el is not visible too.
...
function watchAppear(context, fireNow) {
  ...
  var checkResults = checkHandlers(handlers); // no appear or offsetAppear handler was bound.
...
var noUnitsNumberKeys = ['flex', 'opacity', 'zIndex', 'fontWeight', 'lines']; // whether to support using 0.5px to paint 1px width border.
...
function limitScale(val, limit) {
  ...
  var newVal = Math.abs(val) > limit ? val : sign * limit; // support 1px device width.
...
function autoPrefix(style) {
  var prefixed = addPrefix(style); // flex only added WebkitFlex. Should add WebkitBoxFlex also.
...
function getHeadStyleMap() {
  ...
  var res = Array.from(styleSheetsArr).reduce(function (pre, styleSheet) {
    ...
    if ( // css in a link. just ignore this. probably a link stylesheet.
    styleSheet.ownerNode.tagName.toLowerCase() === 'link' || !styleSheet.ownerNode.textContent // pseudo class styleSheet node is generated by weex. just ignore it.
...
function getComponentStyle(context, extract) {
  ...
  if (pos === 'fixed') {
    ...
    delete prefixedStyle.position; // use native sticky.
    ...
    if ((this === this.$root && this.$options || tagName && typeof weex._components[tagName] === 'undefined' && !disposed[tagName]) && !this._secondScanned) {
      ...
      if (thisHookIdx !== len - 1) {
        ...
        hooks[len - 1] = function () {
          ...
          func.call(this); // scan the new appended styleSheet.
...
window.weex = weex$4;
weex$4._styleMap = {};
['getComponentStyle', 'extractComponentStyle', 'createEventMap', 'trimTextVNodes'].forEach(function (method) {
...
function _init(doc) {
  ...
  events.forEach(function (evt) {
     ...
     */
    var option = evt === 'click' ? true : needPassive.indexOf(evt) > -1 && _sp ? {
      passive: true
    } : false;
...
function getCustomStyle(context, mergedStyle) {
  ...
  var bgSize = ['cover', 'contain', stretch].indexOf(resize) > -1 ? resize : stretch; // compatibility: http://caniuse.com/#search=background-size
...
var slideMixin = {
  ...
  methods: {
    ...
    _prepareNodes: function _prepareNodes() {
      ...
      var curCount = this.frameCount; // frameCount updated in runtime, should init again.
...
function getWeb(weex) {
  ...
  return {
    ...
    mounted: function mounted() {
      ...
      if (this.$el) {
        this.$emit('pagestart', createEvent(this.$el, 'pagestart', {
          url: this.src
        }));
        this.$el.addEventListener('load', function (event) {
          this$1.$emit('pagefinish', createEvent(this$1.$el, 'pagefinish', {
            url: this$1.src
          }));
        });
      }
...
function transitionOnce(vnode, config, callback) {
  ...
  var dom = vnode.$el; // trigger image lazyloading by force.
  ...
  scrollToElement: function (vnode, options) {
    ...
    if (ct && el) {
      ...
      */
      ...
      if (options) {
        offset += options.offset && options.offset * weex.config.env.scale || 0; // offset *= weex.config.env.scale /* adapt offset to different screen scales. */
      } else {}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_router__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_HelloWorld__ = __webpack_require__(11);
...
module.exports = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  routes: [{
    path: '/',
    name: 'HelloWorld',
...
Component.options.__file = "E:\\test\\Native-app\\weex\\CFD\\src\\components\\HelloWorld.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18b259c2", Component.options)
  } else {
    hotAPI.reload("data-v-18b259c2", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-18b259c2", module.exports)
  }
}
...
Component.options.__file = "E:\\test\\Native-app\\weex\\CFD\\src\\index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f19b97b", Component.options)
  } else {
    hotAPI.reload("data-v-4f19b97b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(17)("fb5b4c12", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f19b97b\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f19b97b\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
// module
exports.push([module.i, "\n.wrapper[data-v-4f19b97b] {\n  -ms-flex-pack: center;\n      justify-content: center;\n  -ms-flex-align: center;\n      align-items: center;\n}\n.logo[data-v-4f19b97b] {\n  width: 424px;\n  height: 200px;\n}\n.greeting[data-v-4f19b97b] {\n  text-align: center;\n  margin-top: 70px;\n  font-size: 50px;\n  color: #41B883;\n}\n.message[data-v-4f19b97b] {\n  margin: 30px;\n  font-size: 32px;\n  color: #727272;\n}\n", ""]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4f19b97b", module.exports)
  }
}
